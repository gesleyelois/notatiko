...
- **A marca no gramado.** Ela já morou no círculo central, em luminosidade
  ...
  basta.
- **O recorte de brasão no escudo do topo.** O placar do app corta em forma
  de escudo porque ali ele é um emblema de 34px. Numa imagem que representa o
  clube, escudo redondo ou com faixa de texto embaixo ficava com as pontas
  comidas: agora vai inteiro, dentro de uma caixa quadrada.
